...
function About() {
  return (
    <section className="About white" id="aboutAMB">
        <div className="title">About AMB</div>
        <div className="subtitle">AMB Collaborative believes in assisting organisations to achieve the following:</div>
        <p>• To develop disciplined and innovative organisations through a programme management approach (Being innovative also means staying true to organisational objectives.)</p>
